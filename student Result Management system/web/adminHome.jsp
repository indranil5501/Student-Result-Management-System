        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="postbbb      ">
                                <div class="form-group row">
...
catch(Exception e)
{
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact indranil5501.
Designed & Developed by indranil5501</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ indranil5501</h5></center> 
  <hr class="new1">
<br>
</body>
</html>